...
namespace Server.Mobiles
{
	...
	public class FrostwoodEnt : BaseCreature
	{
		...
		[Constructable]
		public FrostwoodEnt() : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = "an ent";
			Title = "(Frostwood)";
			Body = 301;
			...
			VirtualArmor = 24;
			PackItem( new FrostwoodLog( Utility.RandomMinMax( 23, 34 ) ) );
		}
		...
		public FrostwoodEnt( Serial serial ) : base( serial )
		{
		}
