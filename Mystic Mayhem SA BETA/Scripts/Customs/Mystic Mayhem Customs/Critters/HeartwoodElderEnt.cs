...
namespace Server.Mobiles
{
	...
	public class HeartwoodElderEnt : BaseCreature
	{
		[Constructable]
		public HeartwoodElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Title = "(Heartwood)";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new HeartwoodLog( Utility.RandomMinMax( 40, 75 ) ) );
		}
		...
		public override int BreathEffectHue{ get{ return 1193; } }
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public HeartwoodElderEnt( Serial serial ) : base( serial )
		{
		}
