...
namespace Server.Mobiles
{
	...
	public class BloodwoodEnt : BaseCreature
	{
		...
		[Constructable]
		public BloodwoodEnt() : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = "an ent";
			Title = "(Bloodwood)";
			Body = 301;
			...
			VirtualArmor = 24;
			PackItem( new BloodwoodLog( Utility.RandomMinMax( 23, 34 ) ) );
		}
		...
		public BloodwoodEnt( Serial serial ) : base( serial )
		{
		}
