...
namespace Server.Mobiles
{
	...
	public class YewEnt : BaseCreature
	{
		...
		[Constructable]
		public YewEnt() : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = "an ent";
			Title = "(Yew)";
			Body = 301;
			...
			VirtualArmor = 24;
			PackItem( new YewLog( Utility.RandomMinMax( 23, 34 ) ) );
		}
		...
		public YewEnt( Serial serial ) : base( serial )
		{
		}
