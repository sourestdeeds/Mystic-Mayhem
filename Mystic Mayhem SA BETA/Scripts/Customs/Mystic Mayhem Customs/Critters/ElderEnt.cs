...
namespace Server.Mobiles
{
	...
	public class ElderEnt : BaseCreature
	{
		[Constructable]
		public ElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new Log( Utility.RandomMinMax( 40, 75 ) ) );
		}
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public ElderEnt( Serial serial ) : base( serial )
		{
		}
