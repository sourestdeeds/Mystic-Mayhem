...
namespace Server.Mobiles
{
	...
	public class YewElderEnt : BaseCreature
	{
		[Constructable]
		public YewElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Title = "{Yew)";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new YewLog( Utility.RandomMinMax( 40, 75 ) ) );
		}
		...
		public override int BreathEffectHue{ get{ return 1192; } }
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public YewElderEnt( Serial serial ) : base( serial )
		{
		}
