...
namespace Server.Mobiles
{
	...
	public class FrostwoodElderEnt : BaseCreature
	{
		[Constructable]
		public FrostwoodElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Title = "(Frostwood)";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new FrostwoodLog( Utility.RandomMinMax( 40, 75 ) ) );
		}
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public FrostwoodElderEnt( Serial serial ) : base( serial )
		{
		}
