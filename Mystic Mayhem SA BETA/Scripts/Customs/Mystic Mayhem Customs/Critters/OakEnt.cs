...
namespace Server.Mobiles
{
	...
	public class OakEnt : BaseCreature
	{
		...
		[Constructable]
		public OakEnt() : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = "an ent";
			Title = "(Oak)";
			Body = 301;
			...
			VirtualArmor = 24;
			PackItem( new OakLog( Utility.RandomMinMax( 23, 34 ) ) );
		}
		...
		public OakEnt( Serial serial ) : base( serial )
		{
		}
