	...
	public class Aghor : BaseCreature
	{
		...
		public override void OnDeath( Container c )
		{
			...
			if ( Utility.RandomDouble() < 0.3 )
			{
				...
				{
					case 0: c.DropItem( new AghorHelm() ); break;
					case 1: c.DropItem( new AghorGloves() ); break;
					case 2: c.DropItem( new AghorChest() );	break;		
					case 3: c.DropItem( new AghorArms() ); break;
					case 4: c.DropItem( new AghorLegs() ); break;
				}
			}
		}
