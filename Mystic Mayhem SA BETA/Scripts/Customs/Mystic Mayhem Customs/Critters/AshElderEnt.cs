...
namespace Server.Mobiles
{
	...
	public class AshElderEnt : BaseCreature
	{
		[Constructable]
		public AshElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Title = "(Ash)";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new AshLog( Utility.RandomMinMax( 40, 75 ) ) );
		}
		...
		public override int BreathEffectHue{ get{ return 1191; } }
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public AshElderEnt( Serial serial ) : base( serial )
		{
		}
