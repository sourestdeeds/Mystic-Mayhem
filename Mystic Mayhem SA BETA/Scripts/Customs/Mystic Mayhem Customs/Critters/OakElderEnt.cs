...
namespace Server.Mobiles
{
	...
	public class OakElderEnt : BaseCreature
	{
		[Constructable]
		public OakElderEnt () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an elder ent";
			Title = "(Oak)";
			Body = 285;
			...
			VirtualArmor = 80;
			PackItem( new OakLog( Utility.RandomMinMax( 40, 75 ) ) );
		}
		...
		public override int BreathEffectHue{ get{ return 2010; } }
...
//		public override HideType HideType{ get{ return HideType.Barbed; } }
		...
		public OakElderEnt( Serial serial ) : base( serial )
		{
		}
