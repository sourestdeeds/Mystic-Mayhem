...
{
    public class LegsofExpertCooking : LeatherLegs
    {
        ...
        [Constructable]
        public LegsofExpertCooking()
        {
            Name = "Legs of Expert Cooking";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("LegsofExpertCooking");
        ...
        public LegsofExpertCooking(Serial serial) : base( serial )
        {
        }
