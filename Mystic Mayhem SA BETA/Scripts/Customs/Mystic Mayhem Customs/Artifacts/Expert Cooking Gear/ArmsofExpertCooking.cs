...
{
    public class ArmsofExpertCooking : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofExpertCooking()
        {
            Name = "Arms of Expert Cooking";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("ArmsofExpertCooking");
        ...
        public ArmsofExpertCooking(Serial serial) : base( serial )
        {
        }
