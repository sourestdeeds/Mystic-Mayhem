...
{
    public class CapofExpertCooking : LeatherCap
    {
        ...
        [Constructable]
        public CapofExpertCooking()
        {
            Name = "Cap of Expert Cooking";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("CapofExpertCooking");
        ...
        public CapofExpertCooking(Serial serial) : base( serial )
        {
        }
