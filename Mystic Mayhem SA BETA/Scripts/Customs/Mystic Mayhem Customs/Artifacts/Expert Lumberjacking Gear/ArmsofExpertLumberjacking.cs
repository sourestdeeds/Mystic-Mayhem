...
{
    public class ArmsofExpertLumberjacking : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofExpertLumberjacking()
        {
            Name = "Arms of Expert Lumberjacking";
            Hue = 1269;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("ArmsofExpertLumberjacking");
        ...
        public ArmsofExpertLumberjacking(Serial serial) : base( serial )
        {
        }
