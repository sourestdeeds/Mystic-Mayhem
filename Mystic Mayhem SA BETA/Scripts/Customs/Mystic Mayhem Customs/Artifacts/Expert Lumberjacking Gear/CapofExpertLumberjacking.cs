...
{
    public class CapofExpertLumberjacking : LeatherCap
    {
        ...
        [Constructable]
        public CapofExpertLumberjacking()
        {
            Name = "Cap of Expert Lumberjacking";
            Hue = 1269;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("CapofExpertLumberjacking");
        ...
        public CapofExpertLumberjacking(Serial serial) : base( serial )
        {
        }
