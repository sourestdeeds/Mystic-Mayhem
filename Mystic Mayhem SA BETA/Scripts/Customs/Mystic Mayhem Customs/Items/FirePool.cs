...
namespace Server.Items
{
	public class FirePool : Item
	{
		...
		[Constructable]
		public FirePool() : this( TimeSpan.FromSeconds( 10.0 ), 2, 5 )
		{
		}

		public override string DefaultName { get { return "fire pool"; } }

		[Constructable]
		public FirePool( TimeSpan duration, int minDamage, int maxDamage )
			: base( 14089 )
		{
			//Hue = 0x3F;
			Movable = false;
		...
		public FirePool( Serial serial ) : base( serial )
		{
		}
