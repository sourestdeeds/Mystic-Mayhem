...
{ 
	...
	{ 
		private AccessLevel m_AccessLevel = AccessLevel.GameMaster;
	...
	public class VendorGump : Gump
	{
		...
		public string Color( string text, int color )
		{
			...
			if ( !m_Stone.EditMode )
			{
				...
				AddLabel( 440, 120, 1152, "Check Out" );
			}
//aa
			AddLabel( 410, 160, 5, m_Shopper.ItemList.Count.ToString() );
			AddLabel( 440, 160, 5, "Items in" );
			AddLabel( 425, 175, 5, "Shopping Cart" );			
//aa
			AddLabel( 410, 260, 1152, "The (B) beside" );
			AddLabel( 410, 275, 1152, "items and creatures" );
			AddLabel( 410, 290, 1152, "stands for blessing" );
			AddLabel( 410, 305, 1152, "or bonding." );
	...
	public class VendorStoneBuyGump : Gump
	{
		...
		private VendorStone m_Stone;
			...
			AddLabel( 130, 17, 5, "Total Purchase: "+m_Shopper.TotalPrice() );
