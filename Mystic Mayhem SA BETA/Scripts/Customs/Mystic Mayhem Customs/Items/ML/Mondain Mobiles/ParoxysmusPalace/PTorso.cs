   	...
   	{ 
		...
		public PTorso() : base( 0x1CE0 )
		{
			...
			m_TimeEnd = DateTime.Now + TimeSpan.FromHours( 8.0 );
            	...
            	public PTorso( Serial serial ) : base ( serial ) 
            	{             
           	}
		...
		{ 
			...
			public DeleteTimer( PTorso item ) : base( TimeSpan.FromMinutes( 20.0 ), TimeSpan.FromMinutes( 20.0 ) )
			{ 
				di = item;
			}
