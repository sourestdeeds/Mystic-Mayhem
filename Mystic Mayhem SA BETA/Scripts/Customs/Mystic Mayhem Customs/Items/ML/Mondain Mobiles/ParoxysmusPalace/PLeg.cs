   	...
   	{ 
		...
		public PLeg() : base( 0x1CE2 )
		{
			...
			m_TimeEnd = DateTime.Now + TimeSpan.FromHours( 8.0 );
            	...
            	public PLeg( Serial serial ) : base ( serial ) 
            	{             
           	}
		...
		{ 
			...
			public DeleteTimer( PLeg item ) : base( TimeSpan.FromMinutes( 20.0 ), TimeSpan.FromMinutes( 20.0 ) )
			{ 
				di = item;
			}
