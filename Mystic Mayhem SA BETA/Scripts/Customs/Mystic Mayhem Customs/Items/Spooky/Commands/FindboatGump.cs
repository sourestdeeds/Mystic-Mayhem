...
namespace Server.Gumps
{
	public class FindboatGump : Gump
	{
		...
		public FindboatGump( Mobile from, ArrayList list, int page ) : base( 50, 40 )
		{
			...
			AddLabelCropped( 160, 16, 120, 20, 1152, "Owner" );
			AddLabelCropped( 292, 16, 120, 20, 1152, "Location" );
			AddLabel( 80, 290, 93, String.Format( "Paradise Boat Locator             {0} Boats are on the water", boats ));
		...
		private void AddDetails( int index )
		{
		   try{
			if ( index < m_List.Count )
			{
				...
				AddLabel(160, 40 +(row * 20), 1152, String.Format( "{0}", boat.Owner.Name ));
