		...
		private class CorpseTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else
				{
					...
					else if ( m_Quest.NMonsterType == "Toxic Elemental" ) { M_Type = typeof(ToxicElemental); }
					...
					if (
					( m_Quest.NLocation == "the Hedge Maze" && from.Map == Map.Trammel && from.X >= 1032 && from.Y >= 2159 && from.X <= 1256 && from.Y <= 2304 ) ||
					( m_Quest.NLocation == "Dungeon Destard" && from.Map == Map.Trammel && from.X >= 5121 && from.Y >= 769 && from.X <= 5372 && from.Y <= 1020 ) ||
					( m_Quest.NLocation == "the Britain Cemetery" && from.Map == Map.Trammel && from.X >= 1336 && from.Y >= 1443 && from.X <= 1390 && from.Y <= 1493 ) ||
					( m_Quest.NLocation == "the Britain Cemetery" && from.Map == Map.Trammel && from.X >= 1336 && from.Y >= 1487 && from.X <= 1375 && from.Y <= 1510 ) ||
					( m_Quest.NLocation == "Dungeon Shame (Level 1)" && from.Map == Map.Trammel && from.X >= 5376 && from.Y >= 0 && from.X <= 5503 && from.Y <= 127 ) ||
					( m_Quest.NLocation == "Dungeon Shame (Level 2)" && from.Map == Map.Trammel && from.X >= 5505 && from.Y >= 0 && from.X <= 5363 && from.Y <= 127 ) ||
					( m_Quest.NLocation == "Dungeon Shame (Level 3)" && from.Map == Map.Trammel && from.X >= 5376 && from.Y >= 131 && from.X <= 5630 && from.Y <= 256 ) ||
					( m_Quest.NLocation == "Dungeon Shame (Level 5)" && from.Map == Map.Trammel && from.X >= 5636 && from.Y >= 0 && from.X <= 5893 && from.Y <= 126 ) ||
					( m_Quest.NLocation == "Dungeon Shame Mage Towers" && from.Map == Map.Trammel && from.X >= 5431 && from.Y >= 175 && from.X <= 5455 && from.Y <= 199 ) ||
					( m_Quest.NLocation == "Dungeon Shame Mage Towers" && from.Map == Map.Trammel && from.X >= 5567 && from.Y >= 183 && from.X <= 5591 && from.Y <= 207 ) ||
					( m_Quest.NLocation == "the Ice Dungeon" && from.Map == Map.Trammel && from.X >= 5663 && from.Y >= 128 && from.X <= 5892 && from.Y <= 263 ) ||
					( m_Quest.NLocation == "the Ice Demon Lair" && from.Map == Map.Trammel && from.X >= 5650 && from.Y >= 319 && from.X <= 5774 && from.Y <= 370 ) ||
					( m_Quest.NLocation == "the Ratman Fort" && from.Map == Map.Trammel && from.X >= 5795 && from.Y >= 313 && from.X <= 5866 && from.Y <= 384 ) ||
					( m_Quest.NLocation == "Dungeon Hythloth (Level 1)" && from.Map == Map.Trammel && from.X >= 5889 && from.Y >= 0 && from.X <= 6005 && from.Y <= 117 ) ||
					( m_Quest.NLocation == "Dungeon Hythloth (Level 2)" && from.Map == Map.Trammel && from.X >= 5905 && from.Y >= 136 && from.X <= 6002 && from.Y <= 244 ) ||
					( m_Quest.NLocation == "Dungeon Hythloth (Level 3)" && from.Map == Map.Trammel && from.X >= 6025 && from.Y >= 134 && from.X <= 6133 && from.Y <= 237 ) ||
					( m_Quest.NLocation == "Dungeon Hythloth (Level 4)" && from.Map == Map.Trammel && from.X >= 6037 && from.Y >= 22 && from.X <= 6125 && from.Y <= 110 ) ||
					( m_Quest.NLocation == "Dungeon Deceit (Level 1)" && from.Map == Map.Trammel && from.X >= 5128 && from.Y >= 521 && from.X <= 5239 && from.Y <= 642 ) ||
					( m_Quest.NLocation == "Dungeon Deceit (Level 2)" && from.Map == Map.Trammel && from.X >= 5270 && from.Y >= 523 && from.X <= 5356 && from.Y <= 636 ) ||
					( m_Quest.NLocation == "Dungeon Deceit (Level 3)" && from.Map == Map.Trammel && from.X >= 5124 && from.Y >= 644 && from.X <= 5233 && from.Y <= 768 ) ||
					( m_Quest.NLocation == "Dungeon Deceit (Level 4)" && from.Map == Map.Trammel && from.X >= 5249 && from.Y >= 640 && from.X <= 5339 && from.Y <= 764 ) ||
					( m_Quest.NLocation == "Dungeon Despise (Level 1)" && from.Map == Map.Trammel && from.X >= 5377 && from.Y >= 511 && from.X <= 5517 && from.Y <= 639 ) ||
					( m_Quest.NLocation == "Dungeon Despise (Level 2)" && from.Map == Map.Trammel && from.X >= 5377 && from.Y >= 640 && from.X <= 5529 && from.Y <= 767 ) ||
					( m_Quest.NLocation == "Dungeon Despise (Level 3)" && from.Map == Map.Trammel && from.X >= 5375 && from.Y >= 768 && from.X <= 5633 && from.Y <= 1022 ) ||
					( m_Quest.NLocation == "Dungeon Wrong (Level 1)" && from.Map == Map.Trammel && from.X >= 5775 && from.Y >= 512 && from.X <= 5892 && from.Y <= 634 ) ||
					( m_Quest.NLocation == "Dungeon Wrong (Level 2)" && from.Map == Map.Trammel && from.X >= 5635 && from.Y >= 506 && from.X <= 5745 && from.Y <= 588 ) ||
					( m_Quest.NLocation == "Dungeon Wrong (Level 3)" && from.Map == Map.Trammel && from.X >= 5682 && from.Y >= 612 && from.X <= 5724 && from.Y <= 673 ) ||
					( m_Quest.NLocation == "Dungeon Khaldun" && from.Map == Map.Trammel && from.X >= 5377 && from.Y >= 1281 && from.X <= 5627 && from.Y <= 1512 ) ||
					( m_Quest.NLocation == "the Trinsic Passage" && from.Map == Map.Trammel && from.X >= 5886 && from.Y >= 1274 && from.X <= 6047 && from.Y <= 1414 ) ||
					( m_Quest.NLocation == "the Fire Dungeon (Level 1)" && from.Map == Map.Trammel && from.X >= 5765 && from.Y >= 1281 && from.X <= 5884 && from.Y <= 1417 ) ||
					( m_Quest.NLocation == "the Fire Dungeon (Level 1)" && from.Map == Map.Trammel && from.X >= 5666 && from.Y >= 1402 && from.X <= 5887 && from.Y <= 1520 ) ||
					( m_Quest.NLocation == "the Fire Dungeon (Level 2)" && from.Map == Map.Trammel && from.X >= 5633 && from.Y >= 1274 && from.X <= 5763 && from.Y <= 1398 ) ||
					( m_Quest.NLocation == "the Fire Dungeon (Level 2)" && from.Map == Map.Trammel && from.X >= 5630 && from.Y >= 1383 && from.X <= 5664 && from.Y <= 1456 ) ||
					( m_Quest.NLocation == "the Sewers" && from.Map == Map.Trammel && from.X >= 6019 && from.Y >= 1418 && from.X <= 6132 && from.Y <= 1520 ) ||
					( m_Quest.NLocation == "Terathan Keep" && from.Map == Map.Trammel && from.X >= 5124 && from.Y >= 1532 && from.X <= 5376 && from.Y <= 1784 ) ||
