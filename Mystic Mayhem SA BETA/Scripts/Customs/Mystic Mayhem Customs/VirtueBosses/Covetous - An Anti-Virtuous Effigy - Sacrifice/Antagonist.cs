...
namespace Server.Mobiles
{
	...
	public class Antagonist : BaseCreature
	{		
		// peace
		...
		[Constructable]
		public Antagonist() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "An Antagonistic Representation";
			Body =  14;
			Hue = 2419;
		...
		public Antagonist( Serial serial ) : base( serial )
		{
		}
