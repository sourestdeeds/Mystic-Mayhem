...
{
	[CorpseName( "a simulacrum" )]
	public class Simulacrum : BaseCreature
	{
		[Constructable]
		public Simulacrum() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "An Adverse Simulacrum";
			Body = 779;
			BaseSoundID = 0x56C;
			Hue = 2419;
		...
		public Simulacrum( Serial serial ) : base( serial )
		{
		}
