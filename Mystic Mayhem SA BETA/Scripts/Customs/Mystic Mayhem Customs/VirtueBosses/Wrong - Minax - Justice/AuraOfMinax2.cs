...
namespace Server.Mobiles
{
	...
	public class AuraOfMinax2 : BaseCreature
	{
		...
		[Constructable]
		public AuraOfMinax2() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Aura of Minax";
		...
		public AuraOfMinax2( Serial serial ) : base( serial )
		{
		}
