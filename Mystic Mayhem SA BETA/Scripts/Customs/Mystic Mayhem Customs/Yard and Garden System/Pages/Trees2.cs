...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Tree1T:	{from.SendGump(new Trees2(m_Wand,from,3277,2000));break;}
				case (int)Buttons.Leaves1N:	{from.SendGump(new Trees2(m_Wand,from,3278,500));break;}
				case (int)Buttons.Leaves1F:	{from.SendGump(new Trees2(m_Wand,from,3279,500));break;}
				case (int)Buttons.Tree2T:	{from.SendGump(new Trees2(m_Wand,from,3280,2000));break;}
				case (int)Buttons.Leaves2N:	{from.SendGump(new Trees2(m_Wand,from,3281,500));break;}
				case (int)Buttons.Leaves2F:	{from.SendGump(new Trees2(m_Wand,from,3282,500));break;}
				case (int)Buttons.Tree3T:	{from.SendGump(new Trees2(m_Wand,from,3283,2000));break;}
				case (int)Buttons.Leaves3N:	{from.SendGump(new Trees2(m_Wand,from,3284,500));break;}
				case (int)Buttons.Leaves3F:	{from.SendGump(new Trees2(m_Wand,from,3285,500));break;}
				case (int)Buttons.Tree4T:	{from.SendGump(new Trees2(m_Wand,from,3290,2000));break;}
				case (int)Buttons.Leaves4N:	{from.SendGump(new Trees2(m_Wand,from,3291,500));break;}
				case (int)Buttons.Leaves4F:	{from.SendGump(new Trees2(m_Wand,from,3292,500));break;}
				case (int)Buttons.Tree5T:	{from.SendGump(new Trees2(m_Wand,from,3293,2000));break;}
				case (int)Buttons.Leaves5N:	{from.SendGump(new Trees2(m_Wand,from,3294,500));break;}
				case (int)Buttons.Leaves5F:	{from.SendGump(new Trees2(m_Wand,from,3295,500));break;}
				case (int)Buttons.Tree6T:	{from.SendGump(new Trees2(m_Wand,from,3296,2000));break;}
				case (int)Buttons.Leaves6N:	{from.SendGump(new Trees2(m_Wand,from,3297,500));break;}
				case (int)Buttons.Leaves6F:	{from.SendGump(new Trees2(m_Wand,from,3298,500));break;}
				case (int)Buttons.Tree7T:	{from.SendGump(new Trees2(m_Wand,from,3299,2000));break;}
				case (int)Buttons.Leaves7N:	{from.SendGump(new Trees2(m_Wand,from,3300,500));break;}
				case (int)Buttons.Leaves7F:	{from.SendGump(new Trees2(m_Wand,from,3301,500));break;}
				case (int)Buttons.Tree8T:	{from.SendGump(new Trees2(m_Wand,from,3302,2000));break;}
				case (int)Buttons.Leaves8N:	{from.SendGump(new Trees2(m_Wand,from,3303,500));break;}
				case (int)Buttons.Leaves8F:	{from.SendGump(new Trees2(m_Wand,from,3304,500));break;}
			}
		}
