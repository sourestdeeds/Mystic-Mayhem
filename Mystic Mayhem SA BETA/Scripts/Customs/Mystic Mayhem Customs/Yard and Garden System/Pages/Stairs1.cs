...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Stairs1:			{from.SendGump(new Stairs1(m_Wand,from,1006,500));break;}
				case (int)Buttons.Stairs2:			{from.SendGump(new Stairs1(m_Wand,from,1007,500));break;}
				case (int)Buttons.Stairs3:			{from.SendGump(new Stairs1(m_Wand,from,1011,500));break;}
				case (int)Buttons.Stairs4:			{from.SendGump(new Stairs1(m_Wand,from,1015,500));break;}
				case (int)Buttons.Stairs5:			{from.SendGump(new Stairs1(m_Wand,from,1019,500));break;}
				case (int)Buttons.Stairs6:			{from.SendGump(new Stairs1(m_Wand,from,1023,500));break;}
				case (int)Buttons.Stairs7:			{from.SendGump(new Stairs1(m_Wand,from,1801,500));break;}
				case (int)Buttons.Stairs8:			{from.SendGump(new Stairs1(m_Wand,from,1802,500));break;}
				case (int)Buttons.Stairs9:			{from.SendGump(new Stairs1(m_Wand,from,1806,500));break;}
				case (int)Buttons.Stairs10:			{from.SendGump(new Stairs1(m_Wand,from,1810,500));break;}
				case (int)Buttons.Stairs11:			{from.SendGump(new Stairs1(m_Wand,from,1814,500));break;}
				case (int)Buttons.Stairs12:			{from.SendGump(new Stairs1(m_Wand,from,1818,500));break;}
				case (int)Buttons.Stairs13:			{from.SendGump(new Stairs1(m_Wand,from,1822,500));break;}
				case (int)Buttons.Stairs14:			{from.SendGump(new Stairs1(m_Wand,from,1823,500));break;}
				case (int)Buttons.Stairs15:			{from.SendGump(new Stairs1(m_Wand,from,1866,500));break;}
				case (int)Buttons.Stairs16:			{from.SendGump(new Stairs1(m_Wand,from,1870,500));break;}
				case (int)Buttons.Stairs17:			{from.SendGump(new Stairs1(m_Wand,from,1952,500));break;}
				case (int)Buttons.Stairs18:			{from.SendGump(new Stairs1(m_Wand,from,2015,500));break;}
				case (int)Buttons.Stairs19:			{from.SendGump(new Stairs1(m_Wand,from,1825,500));break;}
				case (int)Buttons.Stairs20:			{from.SendGump(new Stairs1(m_Wand,from,1826,500));break;}
				case (int)Buttons.Stairs21:			{from.SendGump(new Stairs1(m_Wand,from,1830,500));break;}
				case (int)Buttons.Stairs22:			{from.SendGump(new Stairs1(m_Wand,from,1834,500));break;}
				case (int)Buttons.Stairs23:			{from.SendGump(new Stairs1(m_Wand,from,1838,500));break;}
				case (int)Buttons.Stairs24:			{from.SendGump(new Stairs1(m_Wand,from,1842,500));break;}
			}
		}
