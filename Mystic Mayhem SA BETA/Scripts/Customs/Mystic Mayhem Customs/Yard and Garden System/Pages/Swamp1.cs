...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Swamp1:		{from.SendGump(new Swamp1(m_Wand,from,12813,1000));break;}
				case (int)Buttons.Swamp2:		{from.SendGump(new Swamp1(m_Wand,from,12819,1000));break;}
				case (int)Buttons.Swamp3:		{from.SendGump(new Swamp1(m_Wand,from,12826,1000));break;}
				case (int)Buttons.Swamp4:		{from.SendGump(new Swamp1(m_Wand,from,12832,1000));break;}
				case (int)Buttons.Swamp5:		{from.SendGump(new Swamp1(m_Wand,from,12838,1000));break;}
				case (int)Buttons.Bubble1:		{from.SendGump(new Swamp1(m_Wand,from,12844,1000));break;}
				case (int)Buttons.Bubble2:		{from.SendGump(new Swamp1(m_Wand,from,12854,1000));break;}
				case (int)Buttons.Bubble3:		{from.SendGump(new Swamp1(m_Wand,from,12865,1000));break;}
				case (int)Buttons.Stump1:		{from.SendGump(new Swamp1(m_Wand,from,12876,1000));break;}
				case (int)Buttons.Stump2:		{from.SendGump(new Swamp1(m_Wand,from,12877,1000));break;}
				case (int)Buttons.LogN1:		{from.SendGump(new Swamp1(m_Wand,from,12878,1000));break;}
				case (int)Buttons.LogN2:		{from.SendGump(new Swamp1(m_Wand,from,12879,1000));break;}
				case (int)Buttons.LogE1:		{from.SendGump(new Swamp1(m_Wand,from,12880,1000));break;}
				case (int)Buttons.LogE2:		{from.SendGump(new Swamp1(m_Wand,from,12881,1000));break;}
				case (int)Buttons.Edging1:		{from.SendGump(new Swamp1(m_Wand,from,12888,1000));break;}
				case (int)Buttons.Edging2:		{from.SendGump(new Swamp1(m_Wand,from,12889,1000));break;}
				case (int)Buttons.Edging3:		{from.SendGump(new Swamp1(m_Wand,from,12890,1000));break;}
				case (int)Buttons.Edging4:		{from.SendGump(new Swamp1(m_Wand,from,12891,1000));break;}
				case (int)Buttons.Edging5:		{from.SendGump(new Swamp1(m_Wand,from,12892,1000));break;}
				case (int)Buttons.Edging6:		{from.SendGump(new Swamp1(m_Wand,from,12893,1000));break;}
				case (int)Buttons.Edging7:		{from.SendGump(new Swamp1(m_Wand,from,12894,1000));break;}
				case (int)Buttons.Edging8:		{from.SendGump(new Swamp1(m_Wand,from,12895,1000));break;}
				case (int)Buttons.Edging9:		{from.SendGump(new Swamp1(m_Wand,from,12896,1000));break;}
				case (int)Buttons.Edging10:		{from.SendGump(new Swamp1(m_Wand,from,12897,1000));break;}
			}
		}
