...
//				case (int)Buttons.Next:			{from.SendGump(new Ground5(from,itemid,price));break;}
				...
				//Pages
				case (int)Buttons.SmallWaveN:	{from.SendGump(new Water2(m_Wand,from,8099,1000));break;}
				case (int)Buttons.SmallWaveW:	{from.SendGump(new Water2(m_Wand,from,8104,1000));break;}
				case (int)Buttons.SmallWaveE:	{from.SendGump(new Water2(m_Wand,from,8109,1000));break;}
				case (int)Buttons.SmallWaveS:	{from.SendGump(new Water2(m_Wand,from,8114,1000));break;}
				case (int)Buttons.LargeWaveN:	{from.SendGump(new Water2(m_Wand,from,8119,1000));break;}
				case (int)Buttons.LargeWaveW:	{from.SendGump(new Water2(m_Wand,from,8124,1000));break;}
				case (int)Buttons.LargeWaveE:	{from.SendGump(new Water2(m_Wand,from,8129,1000));break;}
				case (int)Buttons.LargeWaveS:	{from.SendGump(new Water2(m_Wand,from,8134,1000));break;}
