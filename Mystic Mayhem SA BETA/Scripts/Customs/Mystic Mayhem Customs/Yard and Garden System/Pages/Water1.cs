...
//			Previous,
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.WaterEast:		{from.SendGump(new Water1(m_Wand,from,13422,1000));break;}
				case (int)Buttons.WaterSouth:		{from.SendGump(new Water1(m_Wand,from,13460,1000));break;}
				case (int)Buttons.WaterStagnant:	{from.SendGump(new Water1(m_Wand,from,6039,1000));break;}
				case (int)Buttons.Whirlpool:		{from.SendGump(new Water1(m_Wand,from,13493,1000));break;}
				case (int)Buttons.WaterfallE1:		{from.SendGump(new Water1(m_Wand,from,13555,1000));break;}
				case (int)Buttons.WaterfallE2:		{from.SendGump(new Water1(m_Wand,from,13549,1000));break;}
				case (int)Buttons.WaterfallE3:		{from.SendGump(new Water1(m_Wand,from,13561,1000));break;}
				case (int)Buttons.WaterfallE4:		{from.SendGump(new Water1(m_Wand,from,13567,1000));break;}
				case (int)Buttons.WaterfallE5:		{from.SendGump(new Water1(m_Wand,from,13573,1000));break;}
				case (int)Buttons.WaterfallS1:		{from.SendGump(new Water1(m_Wand,from,13585,1000));break;}
				case (int)Buttons.WaterfallS2:		{from.SendGump(new Water1(m_Wand,from,13579,1000));break;}
				case (int)Buttons.WaterfallS3:		{from.SendGump(new Water1(m_Wand,from,13591,1000));break;}
				case (int)Buttons.WaterfallS4:		{from.SendGump(new Water1(m_Wand,from,13597,1000));break;}
				case (int)Buttons.WaterfallS5:		{from.SendGump(new Water1(m_Wand,from,13603,1000));break;}
				case (int)Buttons.SmallRockE1:		{from.SendGump(new Water1(m_Wand,from,13446,1000));break;}
				case (int)Buttons.SmallRockE2:		{from.SendGump(new Water1(m_Wand,from,13451,1000));break;}
				case (int)Buttons.LargeRockE1:		{from.SendGump(new Water1(m_Wand,from,13345,1000));break;}
				case (int)Buttons.LargeRockE2:		{from.SendGump(new Water1(m_Wand,from,13356,1000));break;}
				case (int)Buttons.SmallRockS1:		{from.SendGump(new Water1(m_Wand,from,13484,1000));break;}
				case (int)Buttons.SmallRockS2:		{from.SendGump(new Water1(m_Wand,from,13488,1000));break;}
				case (int)Buttons.LargeRockS:		{from.SendGump(new Water1(m_Wand,from,13350,1000));break;}
				case (int)Buttons.Post:				{from.SendGump(new Water1(m_Wand,from,942,100));break;}
				case (int)Buttons.Fountain1:		{from.SendGump(new Water1(m_Wand,from,5952,90000));break;}
				case (int)Buttons.Fountain2:		{from.SendGump(new Water1(m_Wand,from,6610,90000));break;}
			}
		}
