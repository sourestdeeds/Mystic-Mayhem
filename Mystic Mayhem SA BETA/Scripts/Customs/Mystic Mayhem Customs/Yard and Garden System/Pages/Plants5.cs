...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case (int)Buttons.Log3:			{from.SendGump(new Plants5(m_Wand,from,3317,330));break;}
				case (int)Buttons.Log4:			{from.SendGump(new Plants5(m_Wand,from,3318,330));break;}
				case (int)Buttons.Log5:			{from.SendGump(new Plants5(m_Wand,from,3319,330));break;}
			}
		}
