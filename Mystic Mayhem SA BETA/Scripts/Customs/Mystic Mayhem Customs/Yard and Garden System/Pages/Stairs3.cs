...
//				case (int)Buttons.Next:				{from.SendGump(new Stairs3(m_Wand,from,0,0));break;}
				//Pages
				case (int)Buttons.Stairs1:			{from.SendGump(new Stairs3(m_Wand,from,1955,500));break;}
				case (int)Buttons.Stairs2:			{from.SendGump(new Stairs3(m_Wand,from,1956,500));break;}
				case (int)Buttons.Stairs3:			{from.SendGump(new Stairs3(m_Wand,from,1960,500));break;}
				case (int)Buttons.Stairs4:			{from.SendGump(new Stairs3(m_Wand,from,1964,500));break;}
				case (int)Buttons.Stairs5:			{from.SendGump(new Stairs3(m_Wand,from,1978,500));break;}
				case (int)Buttons.Stairs6:			{from.SendGump(new Stairs3(m_Wand,from,1979,500));break;}
				case (int)Buttons.Stairs7:			{from.SendGump(new Stairs3(m_Wand,from,1991,500));break;}
				case (int)Buttons.Platform1:		{from.SendGump(new Stairs3(m_Wand,from,1981,500));break;}
				case (int)Buttons.Platform2:		{from.SendGump(new Stairs3(m_Wand,from,1983,500));break;}
				case (int)Buttons.Platform3:		{from.SendGump(new Stairs3(m_Wand,from,1987,500));break;}
				case (int)Buttons.WoodPlanks1:		{from.SendGump(new Stairs3(m_Wand,from,1993,500));break;}
				case (int)Buttons.WoodPlanks2:		{from.SendGump(new Stairs3(m_Wand,from,1997,500));break;}
				case (int)Buttons.Floor1:			{from.SendGump(new Stairs3(m_Wand,from,1173,500));break;}
				case (int)Buttons.Floor2:			{from.SendGump(new Stairs3(m_Wand,from,1193,500));break;}
				case (int)Buttons.Floor3:			{from.SendGump(new Stairs3(m_Wand,from,1250,500));break;}
				case (int)Buttons.Floor4:			{from.SendGump(new Stairs3(m_Wand,from,1289,500));break;}
				case (int)Buttons.Floor5:			{from.SendGump(new Stairs3(m_Wand,from,1294,500));break;}
				case (int)Buttons.Floor6:			{from.SendGump(new Stairs3(m_Wand,from,1301,500));break;}
				case (int)Buttons.Dirt1:			{from.SendGump(new Stairs3(m_Wand,from,1035,500));break;}
				case (int)Buttons.Dirt2:			{from.SendGump(new Stairs3(m_Wand,from,1039,500));break;}
				case (int)Buttons.Dirt3:			{from.SendGump(new Stairs3(m_Wand,from,1043,500));break;}
				case (int)Buttons.Dirt4:			{from.SendGump(new Stairs3(m_Wand,from,1047,500));break;}
				case (int)Buttons.Dirt5:			{from.SendGump(new Stairs3(m_Wand,from,1051,500));break;}
				case (int)Buttons.Dirt6:			{from.SendGump(new Stairs3(m_Wand,from,12789,500));break;}
			}
		}
