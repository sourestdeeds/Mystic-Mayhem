...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.CampionFlowers1:		{from.SendGump(new Plants1(m_Wand,from,3203,1000));break;}
				case (int)Buttons.FoxgloveFlowers1:		{from.SendGump(new Plants1(m_Wand,from,3204,1000));break;}
				case (int)Buttons.OrfluerFlower:		{from.SendGump(new Plants1(m_Wand,from,3205,1000));break;}
				case (int)Buttons.RedPoppies:			{from.SendGump(new Plants1(m_Wand,from,3206,1000));break;}
				case (int)Buttons.CampionFlowers2:		{from.SendGump(new Plants1(m_Wand,from,3207,1000));break;}
				case (int)Buttons.Snowdrops1:			{from.SendGump(new Plants1(m_Wand,from,3208,1000));break;}
				case (int)Buttons.CampionFlowers3:		{from.SendGump(new Plants1(m_Wand,from,3209,1000));break;}
				case (int)Buttons.FoxgloveFlowers2:		{from.SendGump(new Plants1(m_Wand,from,3210,1000));break;}
				case (int)Buttons.WhiteFlowers1:		{from.SendGump(new Plants1(m_Wand,from,3211,1000));break;}
				case (int)Buttons.WhiteFlowers2:		{from.SendGump(new Plants1(m_Wand,from,3212,1000));break;}
				case (int)Buttons.WhitePoppies:			{from.SendGump(new Plants1(m_Wand,from,3213,1000));break;}
				case (int)Buttons.Snowdrops2:			{from.SendGump(new Plants1(m_Wand,from,3214,1000));break;}
				case (int)Buttons.BladePlant:			{from.SendGump(new Plants1(m_Wand,from,3219,1000));break;}
				case (int)Buttons.Bullrushes:			{from.SendGump(new Plants1(m_Wand,from,3220,1000));break;}
				...
				case (int)Buttons.ElephantEar:			{from.SendGump(new Plants1(m_Wand,from,3223,1000));break;}
				case (int)Buttons.FanPlant:				{from.SendGump(new Plants1(m_Wand,from,3224,1000));break;}
