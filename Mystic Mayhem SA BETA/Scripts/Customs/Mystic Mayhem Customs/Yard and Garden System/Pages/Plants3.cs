...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.OrfluerFlowers1:	{from.SendGump(new Plants3(m_Wand,from,3264,1000));break;}
				case (int)Buttons.OrfluerFlowers2:	{from.SendGump(new Plants3(m_Wand,from,3265,1000));break;}
				case (int)Buttons.PampasGrass1:		{from.SendGump(new Plants3(m_Wand,from,3237,1000));break;}
				case (int)Buttons.CenturyPlant1:	{from.SendGump(new Plants3(m_Wand,from,3376,1500));break;}
				case (int)Buttons.CenturyPlant2:	{from.SendGump(new Plants3(m_Wand,from,3377,1500));break;}
				case (int)Buttons.Yucca:			{from.SendGump(new Plants3(m_Wand,from,3383,1500));break;}
				case (int)Buttons.PampasGrass2:		{from.SendGump(new Plants3(m_Wand,from,3268,1000));break;}
				case (int)Buttons.PonytailPalm:		{from.SendGump(new Plants3(m_Wand,from,3238,1000));break;}
				case (int)Buttons.Rushes:			{from.SendGump(new Plants3(m_Wand,from,3239,1000));break;}
				case (int)Buttons.SmallBananaTree:	{from.SendGump(new Plants3(m_Wand,from,3240,1500));break;}
				case (int)Buttons.SnakePlant:		{from.SendGump(new Plants3(m_Wand,from,3241,1000));break;}
				case (int)Buttons.BananaTree:		{from.SendGump(new Plants3(m_Wand,from,3242,1500));break;}

				case (int)Buttons.Fern1:			{from.SendGump(new Plants3(m_Wand,from,3231,1000));break;}
				case (int)Buttons.Fern2:			{from.SendGump(new Plants3(m_Wand,from,3232,1000));break;}
				case (int)Buttons.Fern3:			{from.SendGump(new Plants3(m_Wand,from,3233,1000));break;}
				case (int)Buttons.Fern4:			{from.SendGump(new Plants3(m_Wand,from,3234,1000));break;}
				case (int)Buttons.Fern5:			{from.SendGump(new Plants3(m_Wand,from,3235,1000));break;}
				case (int)Buttons.Fern6:			{from.SendGump(new Plants3(m_Wand,from,3236,1000));break;}
				case (int)Buttons.SpiderTree:		{from.SendGump(new Plants3(m_Wand,from,3273,1500));break;}
				case (int)Buttons.Sapling1:			{from.SendGump(new Plants3(m_Wand,from,3305,1500));break;}
				case (int)Buttons.Sapling2:			{from.SendGump(new Plants3(m_Wand,from,3306,1500));break;}
				...
				case (int)Buttons.JuniperBush:		{from.SendGump(new Plants3(m_Wand,from,3272,1500));break;}
			}
		}
