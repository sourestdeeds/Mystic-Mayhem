...
//				case (int)Buttons.Next:			{from.SendGump(new Trees5(from,0,0));break;}
				...
				//Pages
				case (int)Buttons.Jungle1T:		{from.SendGump(new Trees4(m_Wand,from,3395,4000));break;}
				case (int)Buttons.Leaves1N:		{from.SendGump(new Trees4(m_Wand,from,3401,2000));break;}
				case (int)Buttons.Leaves1O:		{from.SendGump(new Trees4(m_Wand,from,3408,2000));break;}
				case (int)Buttons.Jungle2T:		{from.SendGump(new Trees4(m_Wand,from,3417,4000));break;}
				case (int)Buttons.Leaves2N:		{from.SendGump(new Trees4(m_Wand,from,3423,2000));break;}
				case (int)Buttons.Leaves2O:		{from.SendGump(new Trees4(m_Wand,from,3430,2000));break;}
				case (int)Buttons.Jungle3T:		{from.SendGump(new Trees4(m_Wand,from,3440,4000));break;}
				case (int)Buttons.Leaves3N:		{from.SendGump(new Trees4(m_Wand,from,3446,2000));break;}
				case (int)Buttons.Leaves3O:		{from.SendGump(new Trees4(m_Wand,from,3453,2000));break;}
				case (int)Buttons.Jungle4T:		{from.SendGump(new Trees4(m_Wand,from,3461,4000));break;}
				case (int)Buttons.Leaves4N:		{from.SendGump(new Trees4(m_Wand,from,3465,2000));break;}
				case (int)Buttons.Leaves4O:		{from.SendGump(new Trees4(m_Wand,from,3470,2000));break;}
				case (int)Buttons.YewTreeT:		{from.SendGump(new Trees4(m_Wand,from,4793,10000));break;}
				case (int)Buttons.YewTreeL:		{from.SendGump(new Trees4(m_Wand,from,4802,10000));break;}
				case (int)Buttons.Vines1:		{from.SendGump(new Trees4(m_Wand,from,3413,1000));break;}
				case (int)Buttons.Vines2:		{from.SendGump(new Trees4(m_Wand,from,3436,1000));break;}
				case (int)Buttons.Vines3:		{from.SendGump(new Trees4(m_Wand,from,3457,1000));break;}
				case (int)Buttons.Vines4:		{from.SendGump(new Trees4(m_Wand,from,3474,1000));break;}
				case (int)Buttons.Tree15T:		{from.SendGump(new Trees4(m_Wand,from,3286,2000));break;}
				case (int)Buttons.Leaves15N:	{from.SendGump(new Trees4(m_Wand,from,3287,1000));break;}
				case (int)Buttons.Tree16T:		{from.SendGump(new Trees4(m_Wand,from,3288,2000));break;}
				case (int)Buttons.Leaves16N:	{from.SendGump(new Trees4(m_Wand,from,3289,1000));break;}
