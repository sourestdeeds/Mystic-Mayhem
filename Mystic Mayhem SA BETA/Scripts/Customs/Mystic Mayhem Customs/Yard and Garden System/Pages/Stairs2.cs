...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Stairs1:			{from.SendGump(new Stairs2(m_Wand,from,1848,500));break;}
				case (int)Buttons.Stairs2:			{from.SendGump(new Stairs2(m_Wand,from,1849,500));break;}
				case (int)Buttons.Stairs3:			{from.SendGump(new Stairs2(m_Wand,from,1853,500));break;}
				case (int)Buttons.Stairs4:			{from.SendGump(new Stairs2(m_Wand,from,1861,500));break;}
				case (int)Buttons.Stairs5:			{from.SendGump(new Stairs2(m_Wand,from,1857,500));break;}
				case (int)Buttons.Stairs6:			{from.SendGump(new Stairs2(m_Wand,from,2170,500));break;}
				case (int)Buttons.Stairs7:			{from.SendGump(new Stairs2(m_Wand,from,1872,500));break;}
				case (int)Buttons.Stairs8:			{from.SendGump(new Stairs2(m_Wand,from,1873,500));break;}
				case (int)Buttons.Stairs9:			{from.SendGump(new Stairs2(m_Wand,from,1877,500));break;}
				case (int)Buttons.Stairs10:			{from.SendGump(new Stairs2(m_Wand,from,1881,500));break;}
				case (int)Buttons.Stairs11:			{from.SendGump(new Stairs2(m_Wand,from,1885,500));break;}
				case (int)Buttons.Stairs12:			{from.SendGump(new Stairs2(m_Wand,from,1889,500));break;}
				case (int)Buttons.Stairs13:			{from.SendGump(new Stairs2(m_Wand,from,1900,500));break;}
				case (int)Buttons.Stairs14:			{from.SendGump(new Stairs2(m_Wand,from,1901,500));break;}
				case (int)Buttons.Stairs15:			{from.SendGump(new Stairs2(m_Wand,from,1905,500));break;}
				case (int)Buttons.Stairs16:			{from.SendGump(new Stairs2(m_Wand,from,1909,500));break;}
				case (int)Buttons.Stairs17:			{from.SendGump(new Stairs2(m_Wand,from,1913,500));break;}
				case (int)Buttons.Stairs18:			{from.SendGump(new Stairs2(m_Wand,from,1917,500));break;}
				case (int)Buttons.Stairs19:			{from.SendGump(new Stairs2(m_Wand,from,1928,500));break;}
				case (int)Buttons.Stairs20:			{from.SendGump(new Stairs2(m_Wand,from,1929,500));break;}
				case (int)Buttons.Stairs21:			{from.SendGump(new Stairs2(m_Wand,from,1933,500));break;}
				case (int)Buttons.Stairs22:			{from.SendGump(new Stairs2(m_Wand,from,1937,500));break;}
				case (int)Buttons.Stairs23:			{from.SendGump(new Stairs2(m_Wand,from,1941,500));break;}
				case (int)Buttons.Stairs24:			{from.SendGump(new Stairs2(m_Wand,from,1945,500));break;}
			}
		}
