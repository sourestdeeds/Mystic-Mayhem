...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Tree9T:		{from.SendGump(new Trees3(m_Wand,from,3476,2000));break;}
				case (int)Buttons.Leaves9N:		{from.SendGump(new Trees3(m_Wand,from,3477,500));break;}
				case (int)Buttons.Leaves9O:		{from.SendGump(new Trees3(m_Wand,from,3478,500));break;}
				case (int)Buttons.Leaves9F:		{from.SendGump(new Trees3(m_Wand,from,3479,500));break;}
				case (int)Buttons.Tree10T:		{from.SendGump(new Trees3(m_Wand,from,3480,2000));break;}
				case (int)Buttons.Leaves10N:	{from.SendGump(new Trees3(m_Wand,from,3481,500));break;}
				case (int)Buttons.Leaves10O:	{from.SendGump(new Trees3(m_Wand,from,3482,500));break;}
				case (int)Buttons.Leaves10F:	{from.SendGump(new Trees3(m_Wand,from,3483,500));break;}
				case (int)Buttons.Tree11T:		{from.SendGump(new Trees3(m_Wand,from,3484,2000));break;}
				case (int)Buttons.Leaves11N:	{from.SendGump(new Trees3(m_Wand,from,3485,500));break;}
				case (int)Buttons.Leaves11O:	{from.SendGump(new Trees3(m_Wand,from,3486,500));break;}
				case (int)Buttons.Leaves11F:	{from.SendGump(new Trees3(m_Wand,from,3487,500));break;}
				case (int)Buttons.Tree12T:		{from.SendGump(new Trees3(m_Wand,from,3488,2000));break;}
				case (int)Buttons.Leaves12N:	{from.SendGump(new Trees3(m_Wand,from,3489,500));break;}
				case (int)Buttons.Leaves12O:	{from.SendGump(new Trees3(m_Wand,from,3490,500));break;}
				case (int)Buttons.Leaves12F:	{from.SendGump(new Trees3(m_Wand,from,3491,500));break;}
				case (int)Buttons.Tree13T:		{from.SendGump(new Trees3(m_Wand,from,3492,2000));break;}
				case (int)Buttons.Leaves13N:	{from.SendGump(new Trees3(m_Wand,from,3493,500));break;}
				case (int)Buttons.Leaves13O:	{from.SendGump(new Trees3(m_Wand,from,3494,500));break;}
				case (int)Buttons.Leaves13F:	{from.SendGump(new Trees3(m_Wand,from,3495,500));break;}
				case (int)Buttons.Tree14T:		{from.SendGump(new Trees3(m_Wand,from,3496,2000));break;}
				case (int)Buttons.Leaves14N:	{from.SendGump(new Trees3(m_Wand,from,3497,500));break;}
				case (int)Buttons.Leaves14O:	{from.SendGump(new Trees3(m_Wand,from,3498,500));break;}
				case (int)Buttons.Leaves14F:	{from.SendGump(new Trees3(m_Wand,from,3499,500));break;}
			}
		}
