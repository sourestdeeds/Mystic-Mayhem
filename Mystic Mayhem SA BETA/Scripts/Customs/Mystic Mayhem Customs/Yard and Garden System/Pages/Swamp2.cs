...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Edging11:		{from.SendGump(new Swamp2(m_Wand,from,12898,1000));break;}
				case (int)Buttons.Edging12:		{from.SendGump(new Swamp2(m_Wand,from,12899,1000));break;}
				case (int)Buttons.Edging13:		{from.SendGump(new Swamp2(m_Wand,from,12900,1000));break;}
				case (int)Buttons.Edging14:		{from.SendGump(new Swamp2(m_Wand,from,12901,1000));break;}
				case (int)Buttons.Edging15:		{from.SendGump(new Swamp2(m_Wand,from,12902,1000));break;}
				case (int)Buttons.Edging16:		{from.SendGump(new Swamp2(m_Wand,from,12903,1000));break;}
				case (int)Buttons.Edging17:		{from.SendGump(new Swamp2(m_Wand,from,12904,1000));break;}
