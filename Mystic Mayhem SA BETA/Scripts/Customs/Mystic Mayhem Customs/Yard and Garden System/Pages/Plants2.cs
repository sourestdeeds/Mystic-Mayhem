...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.Grasses1:		{from.SendGump(new Plants2(m_Wand,from,3244,500));break;}
				case (int)Buttons.Grasses2:		{from.SendGump(new Plants2(m_Wand,from,3245,500));break;}
				case (int)Buttons.Grasses3:		{from.SendGump(new Plants2(m_Wand,from,3246,500));break;}
				case (int)Buttons.Grasses4:		{from.SendGump(new Plants2(m_Wand,from,3247,500));break;}
				case (int)Buttons.Grasses5:		{from.SendGump(new Plants2(m_Wand,from,3248,500));break;}
				case (int)Buttons.Grasses6:		{from.SendGump(new Plants2(m_Wand,from,3249,500));break;}
				case (int)Buttons.Grasses7:		{from.SendGump(new Plants2(m_Wand,from,3250,500));break;}
				case (int)Buttons.Grasses8:		{from.SendGump(new Plants2(m_Wand,from,3251,500));break;}
				case (int)Buttons.Grasses9:		{from.SendGump(new Plants2(m_Wand,from,3252,500));break;}
				case (int)Buttons.Grasses10:	{from.SendGump(new Plants2(m_Wand,from,3253,500));break;}
				case (int)Buttons.Grasses11:	{from.SendGump(new Plants2(m_Wand,from,3254,500));break;}
				case (int)Buttons.Grasses12:	{from.SendGump(new Plants2(m_Wand,from,3257,500));break;}
				case (int)Buttons.Grasses13:	{from.SendGump(new Plants2(m_Wand,from,3258,500));break;}
				case (int)Buttons.Grasses14:	{from.SendGump(new Plants2(m_Wand,from,3259,500));break;}
				case (int)Buttons.Grasses15:	{from.SendGump(new Plants2(m_Wand,from,3260,500));break;}
				case (int)Buttons.Grasses16:	{from.SendGump(new Plants2(m_Wand,from,3261,500));break;}
				case (int)Buttons.Grasses17:	{from.SendGump(new Plants2(m_Wand,from,3269,500));break;}
				case (int)Buttons.Grasses18:	{from.SendGump(new Plants2(m_Wand,from,3270,500));break;}
				case (int)Buttons.Grasses19:	{from.SendGump(new Plants2(m_Wand,from,3378,500));break;}
				case (int)Buttons.Grasses20:	{from.SendGump(new Plants2(m_Wand,from,3379,500));break;}
