...
//End Page 1
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				//Pages
				case (int)Buttons.WaterPlant:	{from.SendGump(new Plants4(m_Wand,from,3332,1000));break;}
				case (int)Buttons.Reeds:		{from.SendGump(new Plants4(m_Wand,from,3333,1000));break;}
				...
				case (int)Buttons.Lilypads:		{from.SendGump(new Plants4(m_Wand,from,3339,1000));break;}
				case (int)Buttons.PipeCactus:	{from.SendGump(new Plants4(m_Wand,from,3381,1500));break;}
				case (int)Buttons.Cactus1:		{from.SendGump(new Plants4(m_Wand,from,3365,1000));break;}
				case (int)Buttons.Cactus2:		{from.SendGump(new Plants4(m_Wand,from,3366,1000));break;}
				case (int)Buttons.Cactus3:		{from.SendGump(new Plants4(m_Wand,from,3367,1000));break;}
				case (int)Buttons.Cactus4:		{from.SendGump(new Plants4(m_Wand,from,3368,1000));break;}
				case (int)Buttons.Cactus5:		{from.SendGump(new Plants4(m_Wand,from,3370,1000));break;}
				case (int)Buttons.Cactus6:		{from.SendGump(new Plants4(m_Wand,from,3372,1000));break;}
				case (int)Buttons.Cactus7:		{from.SendGump(new Plants4(m_Wand,from,3374,1000));break;}
