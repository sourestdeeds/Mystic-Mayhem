...
{	
	...
	public class StoreEntry //TODO: use interface that lets this be sortable... IComparable
	{
		//TODO: define gump itemid/hue override properties
		...
		{
			//can't fit test
			if( Amount + item.Amount > ItemStore.MaxAmount )
			{
				return false;
			}
			Amount += item.Amount;
		...
		public Item Withdraw( int amount )
		{
		...
		public virtual Item Withdraw( int amount, bool deedable )
		{
	...
	public class ColumnSeparationEntry : StoreEntry
	{
		...
		public override Item Withdraw( int amount, bool makedeed )
		{
			return null;
		}
	...
	public class ResourceEntry : StoreEntry
	{
		...
		public override Item Withdraw( int amount, bool makedeed )
		{
			Item resource = base.Withdraw( amount, false );
			
			if( resource != null )
			{	
				//if they want you to make a deed and it's a valid deed item
				if( makedeed && ( resource is ICommodity ) )
				{
	...
	public class ToolEntry : StoreEntry
	{
		...
		public override Item Withdraw( int amount, bool makedeed )
		{
			//tools uses remaining are not limited by 60k, unlike resource amount
	...
	public class PotionEntry : StoreEntry
	{
		...
		public override bool Add( Item item )
		{
			...
			//TODO: figure out what to do with potion keg... right now it'll just be deleted
			return true;
		}
