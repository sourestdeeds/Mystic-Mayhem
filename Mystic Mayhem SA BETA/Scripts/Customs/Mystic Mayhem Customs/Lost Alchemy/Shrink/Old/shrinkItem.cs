...
//aa
			else if ( from.Skills[SkillName.AnimalTaming].Value < m_link.MinTameSkill && m_link.MinTameSkill > 29.1 )
			{
				from.SendMessage ( "You don't have enough skill to control that pet." );
				return;
			}
//aa end
			else
