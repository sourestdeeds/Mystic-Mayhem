...
//ST
	public class EtherealHiryu : EtherealMount
	{
		...
		[Constructable]
		public EtherealHiryu() : base( 0x276A, 0x3E94 )  // 1st shrink 2nd mount
		{
	...
	public class EtherealCusidhe : EtherealMount
	{
		...
		[Constructable]
		public EtherealCusidhe() : base( 0x2D96, 0x3E91 )  // 1st shrink 2nd mount
		{
			Name = "an ethereal cu sidhe statuette";
		}
	...
	public class EtherealFrenziedOstard : EtherealMount
	{
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if ( Name == "an ethereal ostard" )
				Name = "an ethereal frenzied ostard";
		}
	}
	public class EtherealUndeadHorse : EtherealMount
	{
		//public override int LabelNumber{ get{ return 1074816; } } // Charger of the Fallen Statuette

		[Constructable]
		public EtherealUndeadHorse() : base( 0x2617, 0x3EBB )
		{
			Name = "an ethereal undead horse";
		}

		public EtherealUndeadHorse( Serial serial ) : base( serial )
		{
		}
