...
namespace Server.Mobiles
{
	...
	{
//ST
		private int m_BCExtraIntA;
		private int m_BCExtraIntB;
		private int m_BCExtraIntC;
		private int m_BCExtraIntD;
		private int m_BCExtraIntE;
		private int m_BCExtraIntF;
		private int m_BCExtraIntG;
		private int m_BCExtraIntH;
		private int m_BCExtraIntI;
		private int m_BCExtraIntJ;

		private string m_BCExtraStrA;
		private string m_BCExtraStrB;
		private string m_BCExtraStrC;
		private string m_BCExtraStrD;
		private string m_BCExtraStrE;
		private string m_BCExtraStrF;
		private string m_BCExtraStrG;
		private string m_BCExtraStrH;
		private string m_BCExtraStrI;
		private string m_BCExtraStrJ;

		private bool m_BCExtraBoolA;
		private bool m_BCExtraBoolB;
		private bool m_BCExtraBoolC;
		private bool m_BCExtraBoolD;
		private bool m_BCExtraBoolE;
		
		
		private bool m_Blackrock;
		private bool m_Tokunian;
		private bool m_Malasian;
		private bool m_Felucian;
		

		private bool m_NoClaim;

		private DateTime m_BCExtraTimeA;
		private DateTime m_BCExtraTimeB;
		private DateTime m_BCExtraTimeC;
		private DateTime m_BCExtraTimeD;
		private DateTime m_BCExtraTimeE;

		private TimeSpan m_BCExtraTimeF;
		private TimeSpan m_BCExtraTimeG;
		private TimeSpan m_BCExtraTimeH;
		private TimeSpan m_BCExtraTimeI;
		private TimeSpan m_BCExtraTimeJ;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool IsFelucian
		{
			get{ return m_Felucian; }
			set
			{
				if ( m_Felucian == value )
					return;
				else if ( value )
					Felucian.Convert( this );
				else
					Felucian.UnConvert( this );
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool IsMalasian
		{
			get{ return m_Malasian; }
			set
			{
				if ( m_Malasian == value )
					return;
				else if ( value )
					Malasian.Convert( this );
				else
					Malasian.UnConvert( this );
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool IsTokunian
		{
			get{ return m_Tokunian; }
			set
			{
				if ( m_Tokunian == value )
					return;
				else if ( value )
					Tokunian.Convert( this );
				else
					Tokunian.UnConvert( this );
...
//st
		...
		public virtual int BreathComputeDamage()
		{
			...
			if ( IsFelucian )
				damage = (int)(damage / Felucian.HitsBuff);
				
			
//st
//Jon
			if ( IsMalasian )
				damage = (int)(damage / Malasian.HitsBuff);
				
			if ( IsTokunian )
				damage = (int)(damage / Tokunian.HitsBuff);
		
			if ( IsBlackrock )
				damage = (int)(damage / Blackrock.HitsBuff);
...
//st
		...
		public override void OnBeforeSpawn(Point3D location, Map m)
		{
			...
			if ( Felucian.CheckConvert( this, location, m ) )
				IsFelucian = true;
				
//st
//Jon
			if ( Malasian.CheckConvert( this, location, m ) )
				IsMalasian = true;
				
			if ( Tokunian.CheckConvert( this, location, m ) )
				IsTokunian = true;
				
			if ( Blackrock.CheckConvert( this, location, m ) )
				IsBlackrock = true;
...
//End
            if ((feathers == 0 && wool == 0 && meat == 0 && hides == 0 && scales == 0 && dragonblood == 0) || Summoned || IsBonded)
			{
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			//ST
			writer.Write( m_BCExtraIntA );
			writer.Write( m_BCExtraIntB );
			writer.Write( m_BCExtraIntC );
			writer.Write( m_BCExtraIntD );
			writer.Write( m_BCExtraIntE );
			writer.Write( m_BCExtraIntF );
			writer.Write( m_BCExtraIntG );
			writer.Write( m_BCExtraIntH );
			writer.Write( m_BCExtraIntI );
			writer.Write( m_BCExtraIntJ );

			writer.Write( m_BCExtraStrA );
			writer.Write( m_BCExtraStrB );
			writer.Write( m_BCExtraStrC );
			writer.Write( m_BCExtraStrD );
			writer.Write( m_BCExtraStrE );
			writer.Write( m_BCExtraStrF );
			writer.Write( m_BCExtraStrG );
			writer.Write( m_BCExtraStrH );
			writer.Write( m_BCExtraStrI );
			writer.Write( m_BCExtraStrJ );

			writer.Write( m_BCExtraBoolA );
			writer.Write( m_BCExtraBoolB );
			writer.Write( m_BCExtraBoolC );
			writer.Write( m_BCExtraBoolD );
			writer.Write( m_BCExtraBoolE );
			writer.Write( m_Blackrock );
			writer.Write( m_Tokunian );
			writer.Write( m_Malasian );
			writer.Write( m_Felucian );
			
			
			

			writer.Write( m_NoClaim );

			writer.Write( m_BCExtraTimeA );
			writer.Write( m_BCExtraTimeB );
			writer.Write( m_BCExtraTimeC );
			writer.Write( m_BCExtraTimeD );
			writer.Write( m_BCExtraTimeE );

			writer.Write( m_BCExtraTimeF );
			writer.Write( m_BCExtraTimeG );
			writer.Write( m_BCExtraTimeH );
			writer.Write( m_BCExtraTimeI );
			writer.Write( m_BCExtraTimeJ );
//ST
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			int version = reader.ReadInt();
					...
					m_BCExtraIntA = reader.ReadInt();
					m_BCExtraIntB = reader.ReadInt();
					m_BCExtraIntC = reader.ReadInt();
					m_BCExtraIntD = reader.ReadInt();
					m_BCExtraIntE = reader.ReadInt();
					m_BCExtraIntF = reader.ReadInt();
					m_BCExtraIntG = reader.ReadInt();
					m_BCExtraIntH = reader.ReadInt();
					m_BCExtraIntI = reader.ReadInt();
					m_BCExtraIntJ = reader.ReadInt();

					m_BCExtraStrA = reader.ReadString();
					m_BCExtraStrB = reader.ReadString();
					m_BCExtraStrC = reader.ReadString();
					m_BCExtraStrD = reader.ReadString();
					m_BCExtraStrE = reader.ReadString();
					m_BCExtraStrF = reader.ReadString();
					m_BCExtraStrG = reader.ReadString();
					m_BCExtraStrH = reader.ReadString();
					m_BCExtraStrI = reader.ReadString();
					m_BCExtraStrJ = reader.ReadString();

					m_BCExtraBoolA = reader.ReadBool();
					m_BCExtraBoolB = reader.ReadBool();
					m_BCExtraBoolC = reader.ReadBool();
					m_BCExtraBoolD = reader.ReadBool();
					m_BCExtraBoolE = reader.ReadBool();
					m_Blackrock = reader.ReadBool();
					m_Tokunian = reader.ReadBool();
					m_Malasian = reader.ReadBool();
					m_Felucian = reader.ReadBool();
					
					
					

					m_NoClaim = reader.ReadBool();

					m_BCExtraTimeA = reader.ReadDateTime();
					m_BCExtraTimeB = reader.ReadDateTime();
					m_BCExtraTimeC = reader.ReadDateTime();
					m_BCExtraTimeD = reader.ReadDateTime();
					m_BCExtraTimeE = reader.ReadDateTime();

					m_BCExtraTimeF = reader.ReadTimeSpan();
					m_BCExtraTimeG = reader.ReadTimeSpan();
					m_BCExtraTimeH = reader.ReadTimeSpan();
					m_BCExtraTimeI = reader.ReadTimeSpan();
					m_BCExtraTimeJ = reader.ReadTimeSpan();
//ST
		...
		//protected virtual BaseAI ForcedAI { get { return new OmniAI( this ); } }
		...
		public bool Tamable
		{
			get
			{
				return m_bTamable && !m_Paragon && !m_Blackrock;
			}
			set
			{
				m_bTamable = value;
		...
		public virtual void GenerateLoot(bool spawning)
		{
			...
			if (m_Blackrock)
            {
	            AddItem(new RandomBlackRock());
	            AddItem( new Silver( Utility.RandomMinMax( 15, 50 )));  
	            AddItem( new Copper( Utility.RandomMinMax( 15, 50 )));  
	            AddItem( new Platinum( Utility.RandomMinMax( 15, 50 ))); 
	            AddItem( new Gold( Utility.RandomMinMax( 1000, 2000 ))); 
	            AddItem( new Ruby( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Amber( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Amethyst( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Citrine( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Diamond( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Emerald( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Sapphire( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new StarSapphire( Utility.RandomMinMax( 1, 5 ) ) );
				AddItem( new Tourmaline( Utility.RandomMinMax( 1, 5 ) ) );
                if (Fame < 1250)
                    AddLoot(LootPack.Meager);
                else if (Fame < 2500)
                    AddLoot(LootPack.Average);
            ...
            if (m_Felucian)
            {
	             AddItem( new Silver( Utility.RandomMinMax( 1, 5 )));  
                if (Fame < 1250)
                    AddLoot(LootPack.Meager);
                else if (Fame < 2500)
                    AddLoot(LootPack.Average);
             ...
             if (m_Tokunian)
            {
	           AddItem( new Copper( Utility.RandomMinMax( 1, 5 )));  
                if (Fame < 1250)
                    AddLoot(LootPack.Meager);
                else if (Fame < 2500)
                    AddLoot(LootPack.Average);
            ...
            if (m_Malasian)
            {
	           AddItem( new Platinum( Utility.RandomMinMax( 1, 5 )));  
		...
		public virtual void OnKilledBy(Mobile mob)
		{
			...
			if (m_Felucian && Felucian.CheckArtifactChance(mob, this))
                Felucian.GiveArtifactTo(mob);
                
             
                
            if (m_Malasian && Malasian.CheckArtifactChance(mob, this))
                Malasian.GiveArtifactTo(mob);
                
             if (m_Tokunian && Tokunian.CheckArtifactChance(mob, this))
                Tokunian.GiveArtifactTo(mob);
                
            if (m_Blackrock && Blackrock.CheckArtifactChance(mob, this))
                Blackrock.GiveArtifactTo(mob);     
