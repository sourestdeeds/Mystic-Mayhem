...
namespace Server.Mobiles
{
    ...
    public enum PlayerFlag // First 16 bits are reserved for default-distro use, start custom flags at 0x00010000
    {
        ...
        #region SA Gemmining
        GemMining 				= 0x00100000,
        ToggleMiningGem 		= 0x00200000,
        #endregion
    }
...
//ST
		private int m_ExtraInt;
		private int m_PMExtraIntB;
		private int m_PMExtraIntC;
		private int m_PMExtraIntD;
		private int m_PMExtraIntE;
		private int m_PMExtraIntF;
		private int m_PMExtraIntG;
		private int m_PMExtraIntH;
		private int m_PMExtraIntI;
		private int m_PMExtraIntJ;

		private string m_PMExtraStrA;
		private string m_PMExtraStrB;
		private string m_PMExtraStrC;
		private string m_PMExtraStrD;
		private string m_PMExtraStrE;
		private string m_PMExtraStrF;
		private string m_PMExtraStrG;
		private string m_PMExtraStrH;
		private string m_PMExtraStrI;
		private string m_PMExtraStrJ;

		private bool m_PMExtraBoolA;
		private bool m_PMExtraBoolB;
		private bool m_PMExtraBoolC;
		private bool m_PMExtraBoolD;
		private bool m_PMExtraBoolE;
		private bool m_PMExtraBoolF;
		private bool m_PMExtraBoolG;
		private bool m_PMExtraBoolH;
		private bool m_PMExtraBoolI;
		private bool m_PMExtraBoolJ;

		private DateTime m_PMExtraTimeA;
		private DateTime m_PMExtraTimeB;
		private DateTime m_PMExtraTimeC;
		private DateTime m_PMExtraTimeD;
		private DateTime m_PMExtraTimeE;

		private TimeSpan m_PMExtraTimeF;
		private TimeSpan m_PMExtraTimeG;
		private TimeSpan m_PMExtraTimeH;
		private TimeSpan m_PMExtraTimeI;
		private TimeSpan m_PMExtraTimeJ;

		[CommandProperty( AccessLevel.GameMaster )]
		public int ExtraInt
		{
			get { return m_ExtraInt; }
			set { m_ExtraInt = value; }
		}
//ST
		...
		*/
        ...
        public override void Resurrect()
        {
            ...
            {
 //ST				Item deathRobe = new DeathRobe();

//				if ( !EquipItem( deathRobe ) )
//st					deathRobe.Delete();
				new RKTimer( this, 90.0 ).Start();
			}
		}
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                case 0:
                    {
                      //ST
					m_ExtraInt = reader.ReadInt();
					m_PMExtraIntB = reader.ReadInt();
					m_PMExtraIntC = reader.ReadInt();
					m_PMExtraIntD = reader.ReadInt();
					m_PMExtraIntE = reader.ReadInt();
					m_PMExtraIntF = reader.ReadInt();
					m_PMExtraIntG = reader.ReadInt();
					m_PMExtraIntH = reader.ReadInt();
					m_PMExtraIntI = reader.ReadInt();
					m_PMExtraIntJ = reader.ReadInt();

					m_PMExtraStrA = reader.ReadString();
					m_PMExtraStrB = reader.ReadString();
					m_PMExtraStrC = reader.ReadString();
					m_PMExtraStrD = reader.ReadString();
					m_PMExtraStrE = reader.ReadString();
					m_PMExtraStrF = reader.ReadString();
					m_PMExtraStrG = reader.ReadString();
					m_PMExtraStrH = reader.ReadString();
					m_PMExtraStrI = reader.ReadString();
					m_PMExtraStrJ = reader.ReadString();

					m_PMExtraBoolA = reader.ReadBool();
					m_PMExtraBoolB = reader.ReadBool();
					m_PMExtraBoolC = reader.ReadBool();
					m_PMExtraBoolD = reader.ReadBool();
					m_PMExtraBoolE = reader.ReadBool();
					m_PMExtraBoolF = reader.ReadBool();
					m_PMExtraBoolG = reader.ReadBool();
					m_PMExtraBoolH = reader.ReadBool();
					m_PMExtraBoolI = reader.ReadBool();
					m_PMExtraBoolJ = reader.ReadBool();

					m_PMExtraTimeA = reader.ReadDateTime();
					m_PMExtraTimeB = reader.ReadDateTime();
					m_PMExtraTimeC = reader.ReadDateTime();
					m_PMExtraTimeD = reader.ReadDateTime();
					m_PMExtraTimeE = reader.ReadDateTime();

					m_PMExtraTimeF = reader.ReadTimeSpan();
					m_PMExtraTimeG = reader.ReadTimeSpan();
					m_PMExtraTimeH = reader.ReadTimeSpan();
					m_PMExtraTimeI = reader.ReadTimeSpan();
					m_PMExtraTimeJ = reader.ReadTimeSpan();
//ST
					  if (version < 28)
                            m_AutoStabled = new List<Mobile>();
                        break;
...
//ST
			writer.Write( m_ExtraInt );
			writer.Write( m_PMExtraIntB );
			writer.Write( m_PMExtraIntC );
			writer.Write( m_PMExtraIntD );
			writer.Write( m_PMExtraIntE );
			writer.Write( m_PMExtraIntF );
			writer.Write( m_PMExtraIntG );
			writer.Write( m_PMExtraIntH );
			writer.Write( m_PMExtraIntI );
			writer.Write( m_PMExtraIntJ );

			writer.Write( m_PMExtraStrA );
			writer.Write( m_PMExtraStrB );
			writer.Write( m_PMExtraStrC );
			writer.Write( m_PMExtraStrD );
			writer.Write( m_PMExtraStrE );
			writer.Write( m_PMExtraStrF );
			writer.Write( m_PMExtraStrG );
			writer.Write( m_PMExtraStrH );
			writer.Write( m_PMExtraStrI );
			writer.Write( m_PMExtraStrJ );

			writer.Write( m_PMExtraBoolA );
			writer.Write( m_PMExtraBoolB );
			writer.Write( m_PMExtraBoolC );
			writer.Write( m_PMExtraBoolD );
			writer.Write( m_PMExtraBoolE );
			writer.Write( m_PMExtraBoolF );
			writer.Write( m_PMExtraBoolG );
			writer.Write( m_PMExtraBoolH );
			writer.Write( m_PMExtraBoolI );
			writer.Write( m_PMExtraBoolJ );

			writer.Write( m_PMExtraTimeA );
			writer.Write( m_PMExtraTimeB );
			writer.Write( m_PMExtraTimeC );
			writer.Write( m_PMExtraTimeD );
			writer.Write( m_PMExtraTimeE );

			writer.Write( m_PMExtraTimeF );
			writer.Write( m_PMExtraTimeG );
			writer.Write( m_PMExtraTimeH );
			writer.Write( m_PMExtraTimeI );
			writer.Write( m_PMExtraTimeJ );
//ST
        }
