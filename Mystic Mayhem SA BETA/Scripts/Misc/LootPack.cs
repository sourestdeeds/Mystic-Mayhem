...
public static readonly LootPack AosHarrower = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,						100.00, "20d100+800" ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 3, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 3, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 3, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 3, 5, 25, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 4, 5, 50, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 4, 5, 50, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 4, 5, 75, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 4, 5, 75, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 5, 5, 75, 100 ),
				new LootPackEntry( false, AosMagicItemsUltraRich,	100.00, 5, 5, 75, 100 ),
				new LootPackEntry( false, Instruments,				  2.00, 1 )
			} );
		#endregion
