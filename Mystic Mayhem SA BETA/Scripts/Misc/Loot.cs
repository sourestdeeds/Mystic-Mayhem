...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_SAWeaponTypes = new Type[]
		{
			...
			typeof( DualPointedSpear ), typeof( DualShortAxes ), typeof( GargishDagger ),
			typeof( GargishTalwar ), typeof( GlassStaff ), typeof( GlassSword ),
			typeof( StoneWarSword ), typeof( Shortblade ), typeof( SerpentStoneStaff )
		};
		public static Type[] SAWeaponTypes { get { return m_MLWeaponTypes; } }
		...
		{
			typeof( GargishKiteShield ), typeof( GargishChaosShield ),
			typeof( GargishOrderShield ), typeof( GargishWoodenShield ),
			typeof( LargePlateShield ), typeof( LargeStoneShield ),
			typeof( SmallPlateShield ), typeof( MediumPlateShield )
		};
		public static Type[] SAShieldTypes { get { return m_SAShieldTypes; } }
		
		private static Type[] m_SAArmorTypes = new Type[]
		{
			typeof( GargishLeatherArms ), typeof( GargishLeatherChest ), typeof( GargishLeatherKilt ),
			typeof( GargishLeatherWingArmor ), typeof( GargishLeatherLegs ),
			typeof( GargishStoneArms ), typeof( GargishStoneChest ), typeof( GargishStoneKilt ),
			typeof( GargishStoneWingArmor ), typeof( GargishStoneLegs ),
			typeof( GargishPlateArms ), typeof( GargishPlateChest ), typeof( GargishPlateKilt ),
			typeof( GargishPlateWingArmor ), typeof( GargishPlateLegs ),
		};
