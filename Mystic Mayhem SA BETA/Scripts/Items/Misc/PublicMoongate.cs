...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		public static readonly PMList TerMur =
			new PMList( 1113602, 1113602, Map.TerMur, new PMEntry[]
				{
					new PMEntry( new Point3D( 852,  3526, -43 ), 1113603 ), // Isamu-Jima
					new PMEntry( new Point3D(  926, 3989, -36 ), 1112572 ), // Makoto-Jima
					//new PMEntry( new Point3D(  270,  628, 15 ), 1063414 )  // Homare-Jima
				} );
		...
		public static readonly PMList[] AOSLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, TerMur };
		...
		public static readonly PMList[] RedLists		= new PMList[] { Felucca, Ilshenar, Malas, Tokuno, TerMur };
	...
	public class MoongateGump : Gump
	{
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			else if ( m_Mobile.Player && m_Mobile.Kills >= 5 && ( list.Map != Map.Felucca || list.Map != Map.Ilshenar || list.Map != Map.Malas || list.Map != Map.Tokuno || list.Map != Map.TerMur ) )
			{
