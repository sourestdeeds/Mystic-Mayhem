			...
			if ( craftItem != null && !craftItem.ForceNonExceptional )
			{
				...
				if ( Core.ML )
				{
					...
					if ( m_Resource != CraftResource.Heartwood )
					{
						...
						m_AosAttributes.DefendChance += attrInfo.ArmorDefendChance;
						m_AosAttributes.RegenHits += attrInfo.ArmorRegenHits;
						m_AosAttributes.RegenStam += attrInfo.ArmorRegenStam;
						m_AosAttributes.RegenMana += attrInfo.ArmorRegenMana;
					...
					else
					{
						switch ( Utility.Random( 9 ) )
						{
							...
							case 2: m_AosAttributes.DefendChance += attrInfo.ArmorDefendChance; break;
							case 3: m_AosAttributes.RegenHits += attrInfo.ArmorRegenHits; break;
							case 4:	m_AosAttributes.RegenStam += attrInfo.ArmorRegenStam; break;
							case 5:	m_AosAttributes.RegenMana += attrInfo.ArmorRegenMana; break;
							case 6: m_AosArmorAttributes.MageArmor += attrInfo.ArmorMage; break;
							case 7: m_AosAttributes.Luck += attrInfo.ArmorLuck; break;
							case 8: m_AosArmorAttributes.LowerStatReq += attrInfo.ArmorLowerRequirements; break;
						}
					}
				}
			}
