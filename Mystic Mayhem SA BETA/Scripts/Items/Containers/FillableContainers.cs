...
//ST
	public class GrabPack : Backpack
	{
		[Constructable]
		public GrabPack()
		{
		...
		public GrabPack( Serial serial ) : base( serial )
		{
		}
	...
	public class SOSGoldenChest : LockableContainer
	{
		[Constructable]
		public SOSGoldenChest() : base( 0xE41 )
		{
		}

		public SOSGoldenChest( Serial serial ) : base( serial )
		{
		}
	...
	public class SOSWoodenChest : LockableContainer
	{
		[Constructable]
		public SOSWoodenChest() : base( 0xe43 )
		{
			Weight = 2.0;
		}

		public SOSWoodenChest( Serial serial ) : base( serial )
		{
		}
...
//	[Flipable( 0xe43, 0xe42 )]
	public class CampMetalChest : LockableContainer
	{
		[Constructable]
		public CampMetalChest() : base( 0x9AB )
		{
			Weight = 2.0;
		}

		public CampMetalChest( Serial serial ) : base( serial )
		{
		}
