		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				...
				new ChampionSpawnInfo( "Tormented", typeof( Meraktus ), new string[]{ "Cleanser", "Expunger", "Depurator" } , new Type[][]
				{																											// Corrupt
					new Type[]{ typeof( GiantRat ), typeof( Snake ) }, 
					new Type[]{ typeof( Minotaur ), typeof( GiantRat ), typeof( GiantSerpent ) },
					new Type[]{ typeof( MinotaurScout ), typeof( SilverSerpent ), typeof( Drake ) },
					new Type[]{ typeof( Reptalon ), typeof( TormentedMinotaur ), typeof( MinotaurCaptain ) }
				} ),
				#region SA
